...
### Rubberfit
A material-optimization platform for rubber and roll-stock fabrication shops — minimizes cut waste through nesting, kerf-aware planning, and inventory tracking. Currently in private beta.
...
- **Customer code never trains a model.** Zero-retention inference, scoped permissions, no embedding stores. Read the [Sigilix security architecture](https://sigilix.ai/security) for the full picture.
